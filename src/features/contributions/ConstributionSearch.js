...
const ContributionSearch = ({ members, categories }) => {
  // Search form state
            ...
            <Card className="bg-secondary shadow border-0">
              <CardBody className="px-lg-5 py-lg-5">
                <div className="text-center text-muted mb-4">
                  <medium>Search Contributions</medium>
                </div>
                ...
                <div className="table-responsive">
                  <Table hover>
                    ...
                    <tbody>
                      {filteredContributions.map(contribution => (
                        <tr key={contribution.id}>
                          ...
                          <td>
                            {members.find(m => m.id === contribution.member)?.last_name || 'Unknown'}
                          </td>
                          <td>
                            {categories.find(c => c.id === contribution.category)?.category_name || 'Unknown'}
                          </td>
                    ...
                    <button
                        ...
                        onClick={() => navigate(`/dash/contributions/${contribution._id}`)}
                    >
